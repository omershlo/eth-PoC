...
exports.ecsign2 = function(msgHash,mpcSignParams,addressEth){
  ...
  serverCache['q1'] = mpcSignParams.Q1;
  clientCache['q2']= mpcSignParams.Q2;
  serverCache['x1']= mpcSignParams.X1;
  clientCache['x2']= mpcSignParams.X2;
  clientCache['ciphertext']= mpcSignParams.Ckey;
  
 // var {signature_r, signature_s,recid2 } = signMPC(hash2, serverCache,clientCache,mpcSignParams.n,mpcSignParams.g,mpcSignParams.p,mpcSignParams.q,mpcSignParams.lambda,mpcSignParams.preCalculatedDenominator);
//sid:
  const sid = '0'
  var {signature_r, signature_s,recid2 } = signMPC(hash2,sid, serverCache,clientCache,mpcSignParams.n,mpcSignParams.g,mpcSignParams.p,mpcSignParams.q,mpcSignParams.lambda,mpcSignParams.preCalculatedDenominator);
